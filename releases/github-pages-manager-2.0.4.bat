...
function Get-ErrorCategory($message) {
    ...
    if ($text -match "self-update|apply-update|update diagnostic|update diagnosis|stale-after-ok|supervisor|guncelleme supervisor|guncelleme uygulan|guncelleme hedef|yeniden acilamadi") {
        return "update"
    }
